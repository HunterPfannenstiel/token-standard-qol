...
export type ContractContext = Web3ContractContext<
  Web3tERC20,
  Web3tERC20MethodNames,
  Web3tERC20EventsContext,
  Web3tERC20Events
>;
export type Web3tERC20Events = 'Approval' | 'Transfer';
export interface Web3tERC20EventsContext {
  Approval(
    parameters: {
...
export type Web3tERC20MethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
