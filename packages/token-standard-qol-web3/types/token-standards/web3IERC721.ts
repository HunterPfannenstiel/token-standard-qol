...
export type ContractContext = Web3ContractContext<
  Web3IERC721,
  Web3IERC721MethodNames,
  Web3IERC721EventsContext,
  Web3IERC721Events
>;
export type Web3IERC721Events = 'Approval' | 'ApprovalForAll' | 'Transfer';
export interface Web3IERC721EventsContext {
  Approval(
    parameters: {
      filter?: {
        owner?: string | string[];
...
export type Web3IERC721MethodNames =
  | 'approve'
  | 'totalSupply'
  | 'balanceOf'
  | 'getApproved'
